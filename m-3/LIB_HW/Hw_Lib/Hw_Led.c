...
HW_LED_DEF void LED_TOGGLE_RED(void)
{
    GPIO_WriteBit(GPIO_LED, GPIO_LED1_PIN, (BitAction)(1-GPIO_ReadOutputDataBit(GPIO_LED, GPIO_LED1_PIN)));
}
...
HW_LED_DEF void LED_TOGGLE_BLUE(void)
{
    GPIO_WriteBit(GPIO_LED, GPIO_LED3_PIN, (BitAction)(1-GPIO_ReadOutputDataBit(GPIO_LED, GPIO_LED3_PIN)));
}
